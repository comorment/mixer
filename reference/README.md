This folder contains reference files required to run cross-trait or GSA-MiXeR analysis, and additional files (e.g. synthetic data or selected GWAS summarys statistics) used in tutorials.
